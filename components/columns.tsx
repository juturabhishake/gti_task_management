...
const EXCLUDED_KEYS = new Set(['id', 'created_by', 'created_at', 'UpdatedBy', 'UpdatedDate', 'note']);
const DATE_KEYS = new Set(['received_date', 'installation_date', 'inspected_date', 'pm_date', 'pr_date']);

export const generateColumns = ({ onEdit, onDelete, keys }: ColumnsProps): ColumnDef<Equipment>[] => {
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="text-red-600 focus:text-red-600" onClick={() => onDelete(equipment)}>
              Delete
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
